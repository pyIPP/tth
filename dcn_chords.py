...
def chord_len(nshot, diag='EQH', sig=None):

    print('Determining chord length of %s using equ %s' %(sig, diag) )
    dtot = {}
    nttot = 10000
    dt = 0.001
...
#        chord = np.array(chord, dtype=np.float32)
